...
std::string ErrCode::ToString(int errCode)
{
    ...
    static const std::map<int, const char*> errDespMap = {
        ...
        { AuthCredentialSubjectNotExists      , "AuthCredentialSubjectNotExists" },
        { AuthCredentialSubjectIdNotExists    , "AuthCredentialSubjectIdNotExists" },
        { AuthCredentialSubjectBadInstanceId  , "AuthCredentialSubjectBadInstanceId" },
        { AuthCredentialSubjectAppIdNotExists , "AuthCredentialSubjectAppIdNotExists" },
